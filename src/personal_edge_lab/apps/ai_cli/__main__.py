...
def _run_health(
    ...
    *,
    ...
    LOGGER.info(
        "local_llm operation_id=%s command=health outcome=success elapsed_seconds=%.3f provider=%s",
        operation_id,
...
def _run_complete(
    ...
    *,
    ...
    LOGGER.info(
        ...
        "elapsed_seconds=%.3f provider=%s model=%s prompt_tokens=%s "
...
def _input_failure(
    ...
    *,
    ...
    LOGGER.warning(
        ...
        "elapsed_seconds=%.3f prompt_tokens=unavailable completion_tokens=unavailable "
...
def _provider_failure(
    ...
    *,
    ...
    LOGGER.warning(
        ...
        "elapsed_seconds=%.3f http_status=%s retry_eligible=%s retry_after_seconds=%s "
