...
DEFAULT_TOKEN_FILE = "/home/ubuntu/personal-edge-lab/secrets/gmail-token.json"
...
class GmailAuthorizationSettings:
    ...
    def from_env(cls) -> GmailAuthorizationSettings:
        ...
        _validate_client_secret(client_secret_file)
        _validate_token_target(token_file)
...
def _validate_token(path: Path) -> None:
...
def _validate_token_target(path: Path) -> None:
