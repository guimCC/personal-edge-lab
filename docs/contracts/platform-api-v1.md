...
Release `0.13.0` does not change this HTTP contract. Durable read-only Gmail triage remains an
operator CLI and is not exposed through the API or dashboard.
