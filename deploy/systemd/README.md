...
- `personal-edge-lab-api.service` is the separate read-only API unit introduced in Stage 1. It
  intentionally mirrors the known RUBIK identity, paths, restart policy, and hardening without
  depending on the collector service.
